    ...
    <section ref={ref} id="about-preview" className="relative bg-background py-28 md:py-36">
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        ...
        <h2 data-reveal className="max-w-5xl text-4xl font-medium leading-[1.05] tracking-tight text-primary md:text-5xl lg:text-6xl">
          {t("about.title.prefix")} <span className="text-primary/70">{t("about.title.brand")}</span> {t("about.title.suffix")} <em className="font-serif-italic">{t("about.title.italic")}</em>
        </h2>
        ...
        <div data-reveal className="mt-16">
          <img
            ...
            loading="lazy"
            className="mx-auto block w-full h-auto object-contain"
          />
        </div>
      </div>
    </section>
